   ...
   lazy var collView: UICollectionView = {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as? BasicCell {
           // cell.backgroundColor = .gray
            cell.titleLabel.font = UIFont(name: "Poppins", size: 16)
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if isSizeToFitCellsNeeded {
            ...
            let sizeee = CGSize(width: 500, height: self.frame.height)
            ...
            return CGSize.init(width: estimatedRect.size.width, height: self.frame.height - 10)

        }

        return CGSize.init(width: (self.frame.width - 10)/CGFloat(dataArray.count), height: self.frame.size.height)
    }
