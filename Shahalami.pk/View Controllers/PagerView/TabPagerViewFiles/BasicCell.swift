    ...
    override var isSelected: Bool {
        ...
        didSet{
            UIView.animate(withDuration: 0.20) {
                self.indicatorView.backgroundColor = self.isSelected ? UIColor(rgb: 0x1173BC) : UIColor.clear
                self.titleLabel.textColor = self.isSelected ? #colorLiteral(red: 0.06666666667, green: 0.4509803922, blue: 0.737254902, alpha: 1) : UIColor.black
                self.layoutIfNeeded()
            }
        }
